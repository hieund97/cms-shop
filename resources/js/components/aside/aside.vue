<template>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a :href="home_url" class="brand-link">
            <img :src="home_url+`/dist/img/VueShopLogo.png`" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img :src="home_url+`/dist/img/user2-160x160.jpg`" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
